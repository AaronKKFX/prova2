  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Cadastra Fluxo</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="consultaSaldo.php">Consulta Saldo</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="form-container d-flex flex-column justify-content-center align-items-center">
        <form action="cadastraFluxoExe.php" method="post" >
            <fieldset>
                ...
                <div class="row g-3 align-items-center m-2">
                    ...
                    <div class="col-auto">
                        <input type="date" name="data" id="data" class="form-control" aria-describedby="dataFluxo" required>
                    </div>
                </div>
                <div class="row g-3 align-items-center m-2">
                    <div class="col-auto">
                ...
                <div class="row g-3 align-items-center m-2">
                    ...
                    <div class="col-auto">
                        <input type="decimal" name="valor" id="valor" class="form-control" aria-describedby="valorFluxo" required>
                    </div>
                </div>
                <div class="row g-3 align-items-center m-2">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <input type="text" name="historico" id="historico" class="form-control" aria-describedby="historicoFluxo" required>
                    </div>
                </div>
                <div class="row g-3 align-items-center m-2">
                    <div class="col-auto">
